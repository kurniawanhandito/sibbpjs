				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						<ul class="collapsed" id="collapseKelola">
							<li><a class="right-here" href="#">Input Data Pengajuan</a></li>
					...
					<div class="panel-body">
						<form>
							<div class="form-group">
								...
								<input type="text" class="form-control" id="idPengajuan" placeholder="Format : UN1XXXX" required/>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="unit" placeholder="Unit" disabled/>
							</div>
