				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						<ul class="collapsed" id="collapseKelola">
							...
							<li><a class="right-here" href="#">Mutasi Data Barang</a></li>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form>
							...
							<div class="form-group">
								<label for="inputMutasiUnit">Mutasi Ke Unit</label>
								<select class="form-control">
									<option>1</option>
								</select>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="inputIdBarangBaru" placeholder="Format : BRGXXXX" required/>
							</div>
