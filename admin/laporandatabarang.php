	...
	<div class="container-fluid">
		...
		<div class="admin-container row">
				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						<ul class="collapsed" id="collapsePelaporan">
							<li><a class="right-here" href="#">Laporan Data Barang</a></li>
			...
			<div class="admin-content col-md-10">
				...
				<div class="btn-group">
						<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Pilih Kepemilikan <span class="caret"></span></button>
						<ul class="dropdown-menu">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Pelaporan Data Barang</h3>
					</div>
