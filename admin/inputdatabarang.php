				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						<ul class="collapsed" id="collapseKelola">
							<li><a class="right-here" href="#">Input Data Barang</a></li>
					...
					<div class="panel-body">
						<form>
							<div class="form-group">
								...
								<input type="text" class="form-control" id="inputIdBarang" placeholder="ID Barang" required/>
							</div>
							<div class="form-group">
								<label for="inputNamaBarang">Nama Barang</label>
								<input type="text" class="form-control" id="inputNamaBarang" placeholder="Nama Barang" required/>
							</div>
							<div class="form-group">
